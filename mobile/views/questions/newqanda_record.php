    ...
    <div id="page">
        ...
        <div class="page__bd scrollbd">
            ...
            <div class="qanda-record">
                <div class="topicqanda-detail bg-white" style="margin-bottom:10px;">
                ...
                <div class="qnada-q-data-limit" style="padding:15px;background:white;">
                    <span class="appui_switch"><i class="bg-white"></i></span>
                ...
                <div class="qanda-certify-rights bg-white" style="margin-bottom:10px;dispay:none">
                    <div class="fs30 fc-grey999">
                        偷听价格
                        <input id="askPrice"  type="text" class="bg-greyf1 fc-orange fs30 ml10 mr10" placeholder="￥0-1000" value="">元
                    </div>
                </div>
                <!--是否付费收听结束-->
                <div id="chooseAnsWay">
