        ...
        <div class="page__bd scrollbd scrollBottom" id="page__bd" >
            ...
            <div class="circle">
                ...
                <div class="circle-list" id="circleListtuijian" style="top: 0px;display:block">
                    <!--&lt;!&ndash;没有可推荐圈子&ndash;&gt;-->
                    <!--<p class="appui-nocontent">-->
                    <!--<span><img src="../bdt/images/nocontent.png"/></span>-->
                    <!--<span class="mt10 fs28 fc-greyabc mr10" style="display:block;margin-top:.4rem;width:100%;text-align:center;">没有可推荐的圈子</span>-->
                    <!--</p>-->
                    <!--没有可推荐圈子-->
                ...
                <div class="circle-list" id="circleList0" style="top: 0px;display:none">
                    ...
                    <div class="appui-nocontent" >
                        <span><img src="../bdt/images/nocontent.png"/></span>
                        <p class="mt10 fs28 fc-greyabc">您还没有创建圈子</p>
                    </div>
                    <?php if($MyCreated):?>
...
if ((content1!='')&&(content2!='')) {
    $("#circleList0").find(".appui-nocontent").hide();
    $("#circleListtuijian").find(".appui-nocontent").show();
    alert("1")
}else if ((content1 == "") && (content2=="")) {
    alert("2")
    $("#circleList0").find(".appui-nocontent").show();
    $("#circleListwenzi").find(".appui-nocontent").show();
}
//      推荐圈子
var content3=$("#circleListtuijian").find(".circle-name").text();
var content4=$("#circleListtuijian").find(".circle-name").text();
if (content3!== ""&&content4!="") {
    $("#circleListtuijian").find(".appui-nocontent").hide();
    $("#circleListtuijian").find(".appui-nocontent").hide();
